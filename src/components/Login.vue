...
<form class="form_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="nombre@mail.com" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="contraseña" title="Inpit title" name="input-name" type="contraseña" class="input_field" id="contraseña_field">
  </div>
