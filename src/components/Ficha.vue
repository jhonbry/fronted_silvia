    ...
    <div>
        ...
        <div style="width: 1000px; ">
            <div class="btn-agregar">
                <q-btn class="bg-secondary text-white" label="Agregar Vendedores" @click="agregarArea()" />
            </div>
            <div class="q-pa-md" style="padding: 0;">
                <q-table class="my-sticky-dynamic" flat bordered :rows="rows" :columns="columns" :loading="loading"
                    ...
                    :pagination="pagination" :rows-per-page-options="[0]" @virtual-scroll="onScroll" style="height: 600px;">
